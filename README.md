...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-4%2C630%20rows-8250df">
...
> **Important:** this repository is a **public 4,630-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,472 domains** on the canonical page below.

**Public extract:** 4,630 rows · **Live catalog:** 5,622,472 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/markets?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_markets_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/markets?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_markets_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./markets.csv">CSV</a> / <a href="./markets.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_markets_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_markets_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .MARKETS search](https://unique.domains/domains/tld/markets?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_markets_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .MARKETS search](https://unique.domains/domains/tld/markets?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_markets_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./markets.csv) or [Download JSON](./markets.json)
...
- `markets.csv` — public CSV extract (4,630 rows)
- `markets.json` — public JSON extract (4,630 rows)
...
| ----------------------- | ------------------------------------------------ |
| 4,630-row public sample | 5,622,472 live domains                           |
...
| valid.markets   | resell    | $9.99     | —             | 72             | 21     | 5      | Dynadot Inc     |

# Available .MARKETS One-Word Domains (9,819)
...
> The full live catalog for this exact search currently contains **9,819 domains** on the canonical page below.
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,819 live domains                         |
